<template>
  <div>
    <section>
      ...
      <header :class="{ scrolling: scrollPosition > 50 }">
        <NuxtLink class="neon" to="/">
          <font-awesome-icon class="back-btn" :icon="['fas', 'chevron-left']" />  back to main page
        </NuxtLink>
        ...
        >
          <a class="neon" href="#shop">NFT/FT catalogue</a>
          <a class="neon" href="#about">about</a>
          <a class="neon" href="mailto:info@maxzaxster.com">contact</a>
...
@media (max-width: 1100px) {
  section {
  /* background: linear-gradient(193deg, rgba(12,46,68,1) 0%, rgba(61,88,105,1) 28%, rgba(96,93,108,1) 64%, rgba(251,115,119,1) 100%); */
...
@media only screen and (min-device-width: 950px) and (max-device-width: 1625px) {
    header .navigation a {
    margin-right: 7px;
    font-size: 0.7rem;
    letter-spacing: 0px;
...
@media only screen and (min-device-width: 950px) and (max-device-width: 1350px) {
.left_area {
  width: 200px;
}
header {
